...
class _DeviceControlState extends State<DeviceControl> {
  ...
  String hexToStr(String aa) {
    String strHex = aa.substring(2, aa.length);
    List<String> splitted = [];
    for (int i = 0; i < strHex.length; i = i + 2) {
      splitted.add(strHex.substring(i, i + 2));
    }
              ...
              itemBuilder: (context, index) {
                return Column(
                  ...
                  children: [
                    ...
                    // Text(strToHex2),
                    // Text("kom"),
                    Text(hexToStr(_logs[index]._data )),
                    const Padding(
                                  ...
                                  children: <Widget>[
                                    ...
                                    TextButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        List<int> data2 = dataStr.codeUnits;
                                        // Uint8List.fromList(data2);
                                        // for (int i = 0;
                                        //     i < dataStr.length ~/ 2;
                                        //     i++) {
                                        //   data[i] = int.parse(
